...
type HTTPPool struct {
	...
	mu          sync.Mutex
	peers       *consistenthash.Map    //选择具体的key节点
	httpGetters map[string]*httpGetter //映射远程节点和对应的 httpGetter
}

type httpGetter struct {
	baseURL string //即将访问的远程节点的地址
}
...
// 实例化一致性哈希算法，添加了传入的节点，为每一个节点创建了HTTP客户端
// 参数为构建算法的节点的地址
